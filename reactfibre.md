...
React Fiber is a new reconcillation algorithm introduced in React 16.
...
<dl>
  ...
  <dd> When there is a change in the state of a component, React updates the virtual DOM tree. React then compares the virtual DOM to the real DOM and updates the real DOM only when necessary. This process is called reconciliation.</dd>
